...
use Yii2\Extensions\FilePond\Asset\Cdn\{CropperJsAsset, FilePondImageEditPlugin};
use yii\web\AssetBundle;

/**
 * Asset bundle for the FilePond Cropper.js adapter with CDN dependencies.
 */
final class FilePondCropperCdnAsset extends AssetBundle
{
